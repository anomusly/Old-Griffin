            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:tick:1272061375539318795> | **Beastmode enabled! Dangerous Permissions Disabled For Manageable Roles.**`
                        )
                ]
            })
            ...
            await message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:tick:1272061375539318795> | **Beastmode** disabled! Restored Permissions For Manageable Roles.`
                        )
                ]
            })
        } else {
